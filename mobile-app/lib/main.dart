...
class SmartParkingApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Smart Parking - Future City',
      ...
      home: Consumer<ParkingProvider>(
        builder: (context, parkingProvider, child) {
          return parkingProvider.isLoggedIn
              ? const FuturisticParkingDashboard()
              : const LoginScreen();
        },
      ),
    );
...
class FuturisticParkingDashboard extends StatefulWidget {
  const FuturisticParkingDashboard({super.key});

  @override
  State<FuturisticParkingDashboard> createState() =>
      _FuturisticParkingDashboardState();
}

class _FuturisticParkingDashboardState extends State<FuturisticParkingDashboard>
